...
#define SRAM_BASE_FOR_PROJECT 10005000

static volatile int *sram_base = (int*)  SRAM_BASE_FOR_PROJECT;
static volatile int *sram_next1 = (int*) (SRAM_BASE_FOR_PROJECT + 4);
static volatile int *sram_next2 = (int*) (SRAM_BASE_FOR_PROJECT +  8);
static volatile int *sram_next3 = (int*) (SRAM_BASE_FOR_PROJECT +  12);
static volatile int *sram_next4 = (int*) (SRAM_BASE_FOR_PROJECT +  16);
static volatile int *sram_next5 = (int*) (SRAM_BASE_FOR_PROJECT +  20);

//Write to HEX, green, and red LEDs
//enable DMA
//write from address 10005000 to 100050ff
...
static void initialize (void)
{
  ...
  hex_write_3to0(1000, NUM_BASE_10);
